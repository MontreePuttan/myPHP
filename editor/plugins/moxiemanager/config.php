<?php
// General
$moxieManagerConfig['general.license'] = 'UUM6-WBTR-PGKM-LPXX-AJIK-ZC47-UWXJ-HHHU';
...
$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,gif,xls,xlsx,ppt,pptx,txt,docx,doc,zip,pdf';
...
array("username" => "pheeradech.bharkpises@gmail.com", "password" => "t2n19u", "groups" => array("administrator"))
);
